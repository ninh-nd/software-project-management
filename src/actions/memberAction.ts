...
export async function getMembersOfProject(projectName: string): PromiseServer<IMember[]> {
...
export async function assignTask(taskId: string, memberId: string): PromiseServer<IMember> {
